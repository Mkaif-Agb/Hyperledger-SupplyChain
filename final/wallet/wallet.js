...
const walletSchema = require("../src/models/model_wallet");
const User = require('../src/models/model_user');
const { buildCAClient, enrollAdminMongo, userExist, registerAndEnrollUserMongo } = require("../src/helper/CAUtil");
const { getCCP } = require("../src/helper/buildCCP");
const fs = require("fs");
...
class Mongowallet {
    ...
    async put(label, data) {
        ...
        if (label === "admin") {
            ...
            input = { email: label, role: "admin", org: jsonData.mspId, credentials: jsonData.credentials, mspId: jsonData.mspId, version: jsonData.version }
        } else {
