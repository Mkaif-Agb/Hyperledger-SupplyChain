...
function createOrg3() {
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user3:user1pw@localhost:6054 --caname ca-org3 -M "${PWD}/organizations/peerOrganizations/org3.pharmacist.com/users/User1@org3.pharmacist.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org3/tls-cert.pem"
  { set +x; } 2>/dev/null
...
function createOrg4() {
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user4:user1pw@localhost:5054 --caname ca-org4 -M "${PWD}/organizations/peerOrganizations/org4.patient.com/users/User1@org4.patient.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org4/tls-cert.pem"
  { set +x; } 2>/dev/null
